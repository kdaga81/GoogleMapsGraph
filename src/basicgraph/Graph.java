...
public abstract class Graph {
	...
	// Helper method to get number of incoming edges
	public int inDegree(int v) {
		return getInNeighbors(v).size();
	}

	// Helper method to get number of outgoing edges
	public int outDegree(int v) {
		return getNeighbors(v).size();
	}
		
	// Helper method to get total degree
	...
	public static void main (String[] args) {
		GraphLoader.createIntersectionsFile("data/maps/bhatar.map", "data/intersections/bhatar.intersections");
